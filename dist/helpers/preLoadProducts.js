...
const productsToPreLoad = [
    {
        ...
        image: "https://i.imgur.com/eF2yHHX.jpeg",
        categoryId: 1,
        stock: 10,
    },
    {
        ...
        image: "https://i.imgur.com/Gzz4ATt.jpeg",
        categoryId: 2,
        stock: 10,
    },
    {
        ...
        image: "https://i.imgur.com/JwlJW5J.jpeg",
        categoryId: 3,
        stock: 10,
    },
    {
        ...
        image: "https://i.imgur.com/0DkXIrC.jpeg",
        categoryId: 4,
        stock: 10,
    },
    {
        name: "AirPods Max",
        price: 249,
        description: "Immerse yourself in sound with the AirPods Max: active noise cancellation, transparency mode, and customizable fit make the AirPods Max the perfect companion for music, calls, and everything in between. Elevate your audio experience with the AirPods Max.",
        image: "https://i.imgur.com/8Q3OX9z.jpeg",
        categoryId: 5,
        stock: 10,
    },
    {
        ...
        image: "https://i.imgur.com/4pSnCxA.jpeg",
        categoryId: 6,
        stock: 10,
    },
];
const preLoadProducts = async () => {
    const products = await product_repository_1.ProductRepository.find();
    if (!products.length)
        await dataSource_1.AppDataSource.createQueryBuilder()
            .insert()
